--[[!
 ...
 @filename  geany-autoprefixer-css/autoprefixer.lua
 @version   2.5
 @autor     Díaz Urbaneja Víctor Eduardo Diex <diaz.victor@openmailbox.org>
 @date      27.06.2018 17:43:13 -04
]]--

-- the comments were written in Spanish, pre and translated into English
...
prefix = {
	...
	{"display:","-webkit-transition:_val_-o-transition:_val_"},
...
if extension == '.css' then -- if the extension equals
	autoprefixer() -- execution
elseif extencion == '.sass' then -- if the extension equals
	autoprefixer() -- execution
elseif extension == '.less' then -- if the extension equals
	autoprefixer() -- execution
elseif extension == '.html' then -- if the extension equals
	autoprefixer() -- execution
else -- if false
